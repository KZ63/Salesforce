Webruntime.define('lwc/addressForm', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    if (_implicitStylesheets$4) {
      tmpl$f.stylesheets.push.apply(tmpl$f.stylesheets, _implicitStylesheets$4);
    }
    ...
    if (_implicitStylesheets$5) {
      tmpl$k.stylesheets.push.apply(tmpl$k.stylesheets, _implicitStylesheets$5);
    }
    ...
    */
    ...
    if (_implicitStylesheets$2) {
      tmpl$n.stylesheets.push.apply(tmpl$n.stylesheets, _implicitStylesheets$2);
    }
    ...
    * */
    ...
    function tmpl$o($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        props: {
          ...
          "type": "text",
          "maxLength": "7",
          "value": $cmp.postalCode
        },
        key: 0,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.handlePostalCodeChange))
        }
      }, [])])]), api_custom_element("lightning-layout", _lightningLayout, {
        key: 5
      }, [api_custom_element("lightning-layout-item", _lightningLayoutItem, {
    ...
    tmpl$o.stylesheetTokens = {
      hostAttribute: "lwc-addressForm_addressForm-host",
      shadowAttribute: "lwc-addressForm_addressForm"
    };
    ...
    class AddressForm extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
    ...
    lwc.registerDecorators(AddressForm, {
      fields: ["postalCode", "address"]
    });

    var addressForm = lwc.registerComponent(AddressForm, {
      tmpl: _tmpl$n
    });
